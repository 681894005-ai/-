...
```text
C:\Users\PC\Documents\681894005wed/
...
├── receipt.html            # หน้าใบเสร็จรับเงินสำหรับสั่งพิมพ์ออกเครื่องพิมพ์ความร้อน (Thermal Printer)
├── assets/
│   ├── css/
│   │   ├── style.css       # สไตล์ชีทหลัก, เมนู, ตะกร้าสินค้า และหน้าติดตามสถานะ
│   │   ├── admin.css       # สไตล์ชีทหลังร้าน, หน้าล็อกอิน, แผงควบคุม และบอร์ดคิวสั่งอาหาร
│   │   └── print-receipt.css # สไตล์ชีทสำหรับหน้าใบเสร็จสำหรับการพิมพ์ความกว้าง 80 มม.
│   └── js/
│       ├── config.js       # การตั้งค่าเชื่อมฐานข้อมูล Supabase และรหัสทดสอบ
│       ├── database.js     # เลเยอร์ตัวเชื่อมระหว่าง UI และฐานข้อมูล (สลับระหว่าง Cloud/Local อัตโนมัติ)
│       ├── app.js          # ระบบจัดเก็บตะกร้าสินค้า ค้นหา และการ checkout ของลูกค้า
│       ├── tracking.js     # ระบบดึงข้อมูลติดตามสถานะการปรุงอาหาร
│       ├── admin.js        # ระบบล็อกอิน คิวงานออเดอร์ CRUD เมนูอาหาร และการสร้างกราฟ
│       └── receipt.js      # ดึงข้อมูลมาแสดงผลและพิมพ์ใบเสร็จ
```
